<?php
	...
	$mcImageManagerConfig['filesystem.rootpath'] = '../../../../../img/'; // absolute or relative from this script path, required.
	...
	$mcImageManagerConfig['filesystem.extensions'] = "gif,jpg,jpeg,png,bmp,swf,dcr,mov,qt,ram,rm,avi,mpg,mpeg,asf,flv,doc,pdf,docx,xls";
	...
	$mcImageManagerConfig['upload.extensions'] = "gif,jpg,jpeg,png,doc,pdf,docx,xls,swf";
