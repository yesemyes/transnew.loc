...
$root['setup']                 = array('table'=>'rudder','view'=>'getList', 'labelfield'=>'value','order'=>'position');
...
//$root['items']['position']['options'] =
array('type'=>'database','ml'=>1,'table'=>$root['setup']['table'],'value'=>'id','label'=>$root['setup']['labelfield']);
