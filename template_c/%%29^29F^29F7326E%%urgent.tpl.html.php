<?php /* Smarty version 2.6.26, created on 2017-02-02 17:16:30
         compiled from home/urgent.tpl.html */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'Link', 'home/urgent.tpl.html', 6, false),array('function', 'Trans', 'home/urgent.tpl.html', 12, false),array('function', 'FithImageToSize', 'home/urgent.tpl.html', 23, false),array('function', 'BulidQuery', 'home/urgent.tpl.html', 80, false),array('modifier', 'default', 'home/urgent.tpl.html', 48, false),array('modifier', 'is_array', 'home/urgent.tpl.html', 65, false),array('modifier', 'date_format', 'home/urgent.tpl.html', 67, false),)), $this); ?>
<?php if (! empty ( $this->_tpl_vars['this']->topOffers )): ?>

<!-- // top search jamanakvor, estexic petq e <div class="search_blok"> amboxjutyamb jnjel, isk top-search.tpl -um display:none hanel // -->
...
<div class="urgentSaleBlock" style="margin-bottom: 5px;">
<div class="urgentHead"> <span class="urgentTit"><?php echo $this->_plugins['function']['Trans'][0][0]->function_trans(array('param' => 'lastet_added','default' => "Վերջին ավելացվածներ"), $this);?>
</span> 
   
</div>
	

  <div id="jCarouselLiteDemoUrgent" class="cEnd">
    <div class="carousel default"> <a class="sprites prev" href="#"></a>
      <div class="jCarouselLite">
        <ul>
          <?php $_from = $this->_tpl_vars['this']->topOffers; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array'); }if (count($_from)):
    foreach ($_from as $this->_tpl_vars['offer']):
?>
          <?php $this->assign('_images', $this->_tpl_vars['this']->getOfferImages($this->_tpl_vars['offer']['id'])); ?>
          <li> <?php $_smarty_tpl_vars = $this->_tpl_vars;
$this->_smarty_include(array('smarty_include_tpl_file' => "default/rigth.atom.tpl.html", 'smarty_include_vars' => array('_offer' => $this->_tpl_vars['offer'],'images' => $this->_tpl_vars['_images'])));
...
unset($_smarty_tpl_vars);
 ?> </li>
      ...
      <a class="sprites next" href="#"></a> </div>
  </div>
</div>
<?php endif; ?>
