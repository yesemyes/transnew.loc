...
$.widget("ui.slider", $.ui.mouse, {
	...
	_create: function() {
		...
		this.handles.add(this.range).filter("a")
			...
			.focus(function() {
				if (!o.disabled) {
					$(".ui-slider .ui-state-focus2").removeClass('ui-state-focus2'); $(this).addClass('ui-state-focus2');
				} else {
					$(this).blur();
				}
			})
		...
		this.handles.keydown(function(event) {
			...
			if (self._keySliding) {
				...
				$(this).removeClass("ui-state-active2");
			}
	...
	_mouseStop: function(event) {
		...
		this.handles.removeClass("ui-state-active2");
		this._mouseSliding = false;
	...
	_setOption: function(key, value) {
		...
		switch (key) {
			case 'disabled':
				if (value) {
					this.handles.filter(".ui-state-focus2").blur();
					this.handles.removeClass("ui-state-hover2");
